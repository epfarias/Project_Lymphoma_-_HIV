...
dlbcl_clin2 <- dlbcl_clin %>%
     mutate(aa_clin_stg = fct_collapse(aa_clin_stg, 'Stage I-II' = c('Stage I','Stage II'), 'Stage III-IV' = c('Stage III','Stage IV')))
...
write_csv(dlbcl_glm, path = "DBLC_clinical/dlbcl_glm.csv")
```
