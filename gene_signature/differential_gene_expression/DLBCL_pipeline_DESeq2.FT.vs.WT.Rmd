...
Full pipeline of DEA with Glimma - Comparing gene expression by metastasis (ajcc) of DLBCL - Diffuse Large B-Cell Lymphoma
...
data_ajcc <- data_clinical %>% 
              filter(PERSON_NEOPLASM_CANCER_STATUS %in% c("Tumor Free", "With Tumor")) %>% 
              droplevels()
