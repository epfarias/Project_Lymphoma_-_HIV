...
destfile <- "~/GitHub/Project_Lymphoma_DLBC/gene_signature/data/dlbc_exp.txt"
...
destfile <- "~/GitHub/Project_Lymphoma_DLBC/gene_signature/data/data_clinical.txt"
download.file(url, destfile)


data_clinical <- read.delim("~/GitHub/Project_Lymphoma_DLBC/gene_signature/data/data_clinical.txt", comment.char="#", na.strings=c("NA", ""))

dlbc_exp <- read.delim("~/GitHub/Project_Lymphoma_DLBC/gene_signature/data/dlbc_exp.txt", comment.char="#", na.strings=c("NA", ""))
