...
save(data.GSE17189,expr.GSE17189,  file="data/dataset.GSE17189.RData")
```
...
save(data.GSE65418,expr.GSE65418, file="data/dataset.GSE65418.RData")
...
save(data.GSE18826,expr.GSE18826,  file="data/dataset.GSE18826.RData")
```
